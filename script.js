...
function shrink_menu() {
    ...
    let menu_width = (side_menu.clientWidth / main_window.clientWidth)*100;
    let game_width = 100 - menu_width;
    if (hidden_menu) {
        side_menu.style.left = "0";
        shrink_button.style.transform = "rotateY(0deg)"
        game_window.style.width = game_width + "%";
        game_window.style.marginLeft = menu_width + "%";
    } else {
        side_menu.style.left = "-" + menu_width + "%";
